...
namespace WatiN.Core
{
    ...
    public class IE : Browser
    {
        ...
        {
            //using (StreamWriter sw = File.AppendText("watin.txt")) { sw.WriteLine(string.Format("{0}\t{1}", "IE", url)); }
        ...
        protected internal IE(object iwebBrowser2, bool finishInitialization)
        {
            ...
            if (finishInitialization) FinishInitialization(null);
        }
        ...
        private static Process CreateIExploreInNewProcess()
        {
            ...
            if (GetMajorIEVersion() >= 8 && Settings.MakeNewIe8InstanceNoMerge) arguments = "-nomerge " + arguments;
            if (Settings.OpenInIncognitoMode == true) arguments = "-private " + arguments;
            ...
            var m_Proc = Process.Start(startInfo);
